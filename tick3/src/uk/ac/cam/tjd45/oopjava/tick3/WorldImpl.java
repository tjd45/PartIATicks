...
public abstract class WorldImpl implements World {
	...
	public World nextGeneration(int log2StepSize) {
		...
		for (int i = 0; i < 1 << log2StepSize; i++)// TODO: repeat the statement
													// in curly brackets
													// 2^log2StepSize times
		{
	...
	protected boolean computeCell(int col, int row) {
		...
		// A live cell with two or three neighbours lives (a balanced
		// population)
	...
	// Will be implemented by child class. Return true if cell (col,row) is
	// alive.
